...
if (!class_exists('plugin_base')) :
	...
	class plugin_base {
		...
		public function __construct() {
			global $wpdb, $plugin_directory, $plugin_prefix;
		...
		public function add_menu() {
			...
			$menu_slug = 'mycustomplugin-settings';
			$function = array(&$this, 'mycustomplugin_settings');
			...
			$submenu_slug = 'myplugin-second';
			$submenu_function = array(&$this, 'myplugin_second');
		 ...
		 */
		private function check_user($user_can = 'manage_options') {
		...
		public function mycustomplugin_settings() {
			check_user();
		...
		public function myplugin_second() {
			check_user();
			//if passed then display following code to user
